...
protected:
  ...
  void visualizeCollision(
                            ...
                            std_msgs::ColorRGBA& color)
    {
      ...
      if(index > (int)(pairs.size()) || index < 0)
      {
        return;
      }
      lock_.lock();
  ...
  std::vector<planning_environment::CollisionOperationsGenerator::CollidingJointValues> occasionally_collision_joint_values_;
